...
const awsDeveloperQuestions: CertificationQuestion[] = [
...

  {
    ...
    question: "Question 6",
    options: [
      { id: "a", text: "Option A", correct: false, explanation: "Explanation for A." },
      { id: "b", text: "Option B", correct: true, explanation: "Correct answer." },
      { id: "c", text: "Option C", correct: false, explanation: "Explanation for C." },
      { id: "d", text: "Option D", correct: false, explanation: "Explanation for D." },
    ],
  },
  {
    id: "aws7",
