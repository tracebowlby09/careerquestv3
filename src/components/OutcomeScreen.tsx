...
const careerData = {
  ...
  firefighter: {
    icon: "🚒",
    title: "Firefighter",
    successSkill: "Emergency Response & Prioritization",
    successMessage: "Outstanding emergency response! You correctly prioritized fire and medical emergencies to save lives and property.",
    failureSkill: "Scene Assessment",
    failureMessage: "Firefighters must quickly assess threats and prioritize lives. Review the emergency types and try again.",
    keySkills: [
  ...
  police: {
    ...
    successSkill: "Public Safety & Legal Judgment",
    successMessage: "Excellent police work! You prioritized calls based on threat level and public safety needs.",
    failureSkill: "Threat Assessment",
    failureMessage: "Police officers must assess threat levels and respond appropriately. Review the situations and try again.",
    keySkills: [
  ...
  pilot: {
    ...
    successSkill: "Aviation Safety & Decision Making",
    successMessage: "Excellent airmanship! You prioritized flight safety and handled in-flight emergencies properly.",
    failureSkill: "Aeronautical Decision Making",
    failureMessage: "Pilots must prioritize safety over schedules. Review the emergency priorities and try again.",
    keySkills: [
  ...
  veterinarian: {
    icon: "🐕",
    title: "Veterinarian",
    successSkill: "Animal Healthcare & Prioritization",
    successMessage: "Excellent veterinary care! You correctly prioritized animal patients based on urgency and severity.",
    failureSkill: "Clinical Assessment",
    failureMessage: "Veterinary medicine requires quick assessment of animal conditions. Review the symptoms and try again.",
    keySkills: [
      "Animal medical knowledge",
      "Surgical procedures",
  ...
  journalist: {
    icon: "📰",
    title: "Journalist",
    successSkill: "News Judgment & Ethics",
    successMessage: "Great reporting instincts! You prioritized news stories and verified sources appropriately.",
    failureSkill: "News Prioritization",
    failureMessage: "Journalists must identify newsworthy stories and verify facts. Review the source reliability and try again.",
    keySkills: [
      "News judgment and verification",
  ...
  "social-worker": {
    icon: "🤝",
    title: "Social Worker",
    successSkill: "Crisis Assessment & Client Advocacy",
    successMessage: "Excellent social work! You correctly prioritized client cases based on safety and urgency.",
    failureSkill: "Case Prioritization",
    failureMessage: "Social workers must assess safety risks and prioritize accordingly. Review the situations and try again.",
    keySkills: [
      "Crisis intervention",
      "Case management",
  ...
  accountant: {
    icon: "📊",
    title: "Accountant",
    successSkill: "Financial Accuracy & Compliance",
    successMessage: "Excellent accounting work! You prioritized tasks based on deadlines and regulatory requirements.",
    failureSkill: "Financial Prioritization",
    failureMessage: "Accountants must prioritize by deadlines and compliance. Review the task importance and try again.",
    keySkills: [
  ...
  dentist: {
    icon: "🦷",
    title: "Dentist",
    successSkill: "Dental Care & Emergency Response",
    successMessage: "Excellent dental care! You correctly prioritized patients based on infection risk and pain severity.",
    failureSkill: "Treatment Prioritization",
    failureMessage: "Dentists must prioritize based on infection risk and pain. Review the conditions and try again.",
    keySkills: [
  ...
  construction: {
    ...
    successSkill: "Project Management & Safety",
    successMessage: "Excellent construction management! You prioritized tasks for safety and project efficiency.",
    failureSkill: "Job Site Prioritization",
    failureMessage: "Construction managers must prioritize safety and critical path tasks. Review the priorities and try again.",
    keySkills: [
