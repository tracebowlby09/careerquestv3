...
const engineerTasks: Record<Difficulty, StructureTask[]> = {
  easy: [
    ...
    },
    {
      id: "eng-e2",
      title: "Garden Arch",
      description: "Build a decorative garden arch to support 1000 kg of climbing plants.",
      requiredLoad: 1000,
      maxBudget: 300,
      availableMaterials: [
        { id: "wood", name: "Wood Plank", strength: 2000, cost: 50, color: "bg-amber-600" },
        { id: "steel", name: "Steel Beam", strength: 6000, cost: 150, color: "bg-gray-500" },
        { id: "pvc", name: "PVC Pipe", strength: 500, cost: 20, color: "bg-gray-300" },
      ],
      correctSolution: ["wood"],
      timeLimit: 35,
      points: 100,
    },
  ],
  medium: [
    ...
    },
    {
      ...
      description: "Design a parking deck to support 12000 kg per level.",
      requiredLoad: 12000,
      maxBudget: 900,
      availableMaterials: [
        { id: "wood", name: "Wood Plank", strength: 2000, cost: 50, color: "bg-amber-600" },
        { id: "steel", name: "Steel Beam", strength: 6000, cost: 120, color: "bg-gray-500" },
        { id: "concrete", name: "Concrete Block", strength: 8000, cost: 180, color: "bg-gray-400" },
        { id: "prestress", name: "Prestressed Concrete", strength: 14000, cost: 300, color: "bg-gray-600" },
      ],
      correctSolution: ["concrete", "concrete"],
      timeLimit: 65,
      points: 150,
    },
  ],
