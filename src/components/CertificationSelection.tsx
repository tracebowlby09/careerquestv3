      ...
      <div className="relative min-h-[600px]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-10">
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            <div className="whitespace-nowrap text-6xl md:text-8xl font-mono font-bold tracking-widest text-white animate-pulse">
              {morseCode}
            </div>
            <div className="whitespace-nowrap text-6xl md:text-8xl font-mono font-bold tracking-widest text-white animate-pulse" style={{ animationDelay: "1s" }}>
              {morseCode}
            </div>
            <div className="whitespace-nowrap text-6xl md:text-8xl font-mono font-bold tracking-widest text-white animate-pulse" style={{ animationDelay: "2s" }}>
              {morseCode}
            </div>
          </div>
          <div className="absolute inset-0 flex flex-row justify-center items-center -rotate-90">
            <div className="whitespace-nowrap text-6xl md:text-8xl font-mono font-bold tracking-widest text-white opacity-30 animate-pulse" style={{ animationDelay: "0.5s" }}>
              {morseCode}
            </div>
          </div>
        </div>
