...
const difficulties: DifficultyOption[] = [
  {
    ...
    title: "Easy",
    icon: "⚡",
    description: "Basic wiring. 2 circuits to troubleshoot.",
    questions: 2,
  ...
  },
  {
    ...
    title: "Medium",
    icon: "🔧",
    description: "Complex installations. 3 scenarios to master.",
    questions: 3,
  ...
  },
  {
    ...
    title: "Hard",
    icon: "🛠️",
    description: "Expert level. 4 complex circuits to analyze.",
    questions: 4,
    ...
    <ScreenWrapper onOpenSettings={onOpenSettings} onExit={onExit} backgroundImage={backgroundImage}>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-white/90 font-medium">
          Electrician - Select how challenging you want the experience
        </p>
      </div>
