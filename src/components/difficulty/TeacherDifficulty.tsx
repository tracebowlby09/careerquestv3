...
export default function TeacherDifficultySelection({
  onSelectDifficulty,
  onBack,
  onOpenSettings,
  onExit,
  ...
  return (
    <ScreenWrapper onOpenSettings={onOpenSettings} onExit={onExit} backgroundImage={backgroundImage}>
      <button
        onClick={onBack}
        className="mb-6 text-blue-200 hover:text-blue-100 transition-colors flex items-center gap-2"
      >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {difficulties.map((diff) => (
            ...
            >
              ...
              <h3 className="text-3xl font-extrabold text-blue-100 mb-3 text-center drop-shadow-lg tracking-wide">
                {diff.title}
              </h3>
              
              <p className="text-blue-100/80 mb-4 text-center drop-shadow-md font-medium">
                {diff.description}
              </p>
              
              <div className="bg-white/40 backdrop-blur-sm rounded-lg p-3 text-center font-bold text-blue-100 text-lg">
